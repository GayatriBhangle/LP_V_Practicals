 ...
 * 
 */
@WebServiceClient(name = "SimpleInterestService", targetNamespace = "http://myservice.com/", wsdlLocation = "http://localhost:8080/SimpleInterestWebService/SimpleInterestService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SIMPLEINTERESTSERVICE_QNAME = new QName("http://myservice.com/", "SimpleInterestService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/SimpleInterestWebService/SimpleInterestService?wsdl");
    ...
    public SimpleInterestService getSimpleInterestServicePort() {
        return super.getPort(new QName("http://myservice.com/", "SimpleInterestServicePort"), SimpleInterestService.class);
    }
    ...
    public SimpleInterestService getSimpleInterestServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://myservice.com/", "SimpleInterestServicePort"), SimpleInterestService.class, features);
    }
